...
const products = [
  {
    name: 'Money Tree', category: 'EASY CARE', price: 48, originalPrice: 65, rating: 4.8,
    image: 'https://images.pexels.com/photos/6915358/pexels-photo-6915358.jpeg',
    colors: ['#8B9B7E', '#5A6B52', '#E8DDD3']
  },
  {
    name: 'Tough Stuff Collection', category: 'EASY CARE', price: 71, originalPrice: 95, rating: 4.9,
    image: 'https://images.pexels.com/photos/6915358/pexels-photo-6915358.jpeg',
    colors: ['#2C3E2E']
  },
  {
    name: 'Red Prayer Plant', category: 'PET FRIENDLY', price: 38, originalPrice: 52, rating: 4.7,
    image: 'https://images.pexels.com/photos/6964562/pexels-photo-6964562.jpeg',
    colors: ['#D4A373', '#E8DDD3']
  },
  {
    name: 'Bamboo Palm', category: 'LOW LIGHT', price: 85, originalPrice: 115, rating: 4.8,
    image: 'https://images.pexels.com/photos/6964562/pexels-photo-6964562.jpeg',
