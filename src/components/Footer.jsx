...
const Footer = () => {
  return (
    <motion.footer 
      ...
      className="w-full bg-[#F5F4ED] pt-32 pb-16 px-12 border-t border-[#B1B3A9]/10 relative z-10 transition-colors duration-1000"
    >
      ...
      <motion.div 
        ...
        className="max-w-[1440px] mx-auto pt-12 border-t border-[#B1B3A9]/10 flex flex-col md:flex-row justify-between items-center gap-12 font-label text-[10px] tracking-widest uppercase text-[#5E6058]/60 font-black"
      >
