...
const AuthPage = () => {
  ...
  const handleAuth = async (e) => {
    ...
    if (!isLogin) {
      if (!isPasswordStrong) {
        setErrorMsg("Password must be 8+ characters with a special character.");
        return;
      }
    ...
    try {
      if (isLogin) {
        ...
        // Switch to Login tab and clear password fields
        setIsLogin(true);
        setPassword('');
        setConfirmPassword('');
      }
      ...
      if (err.message && err.message.toLowerCase().includes('rate limit')) {
        setErrorMsg('Supabase rate limit exceeded. Please try again later.');
      } else {
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-[45%] bg-[#fbf9f4] flex flex-col h-screen overflow-y-auto">
        ...
        {/* Centered form area */}
        <div className="flex-1 flex items-center justify-center px-10 md:px-16 lg:px-20 py-12">
                  ...
                  <div className="space-y-7 mb-10">
                    ...
                    <div className="relative">
                      <div className="flex justify-between items-end mb-3">
                        ...
                        <button
                          type="button"
                          className="font-label text-[9px] uppercase tracking-[0.15em] text-[#456565]/50 hover:text-[#2F4F4F] transition-colors duration-300"
                        >
                          Forgot?
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="absolute right-0 bottom-3 text-[#2F4F4F]/40 hover:text-[#2F4F4F] transition-colors duration-200"
                      >
                ...
                >
                  ...
                  <div className="space-y-5 mb-8">
                    ...
                    <div>
                      ...
                      <div className="flex items-center border-b border-[#2F4F4F]/15 focus-within:border-[#2F4F4F]/60 transition-colors duration-300">
                        <Phone size={14} className="text-[#2F4F4F]/30 mr-2 mb-2.5 flex-shrink-0" />
                        <input
                          type="tel"
                          value={phone}
                    ...
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        onClick={() => setShowPassword(!showPassword)}
                        className="absolute right-0 bottom-2.5 text-[#2F4F4F]/40 hover:text-[#2F4F4F] transition-colors duration-200"
                      >
                        {showPassword ? <EyeOff size={16} /> : <Eye size={16} />}
                      </button>
                      ...
                      <div className="mt-2 flex gap-4">
                        <span className={`text-[8px] uppercase tracking-widest transition-colors duration-300 ${passwordCriteria.length ? 'text-green-600' : 'text-[#2F4F4F]/30'}`}>
                          ● 8+ Digits
                        </span>
                        <span className={`text-[8px] uppercase tracking-widest transition-colors duration-300 ${passwordCriteria.special ? 'text-green-600' : 'text-[#2F4F4F]/30'}`}>
                          ● Special Char
                        </span>
                        <span className={`ml-auto text-[8px] uppercase font-bold transition-colors duration-300 ${isPasswordStrong ? 'text-green-600' : 'text-orange-400'}`}>
