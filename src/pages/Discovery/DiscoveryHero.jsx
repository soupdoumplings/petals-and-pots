      ...
      <div className="max-w-[1440px] mx-auto px-10 lg:px-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[75vh] items-center">
          ...
          <div className="flex flex-col justify-center py-20 lg:py-32 lg:pr-16">
            <p className="font-label text-[10px] tracking-[0.2em] uppercase text-[#456565] font-semibold mb-6">
              Summer Collection / Vol. 04
            </p>

            <h1 className="font-headline text-[clamp(3.5rem,7vw,6.5rem)] leading-[0.92] tracking-tight text-[#31332C] mb-8">
              Living{' '}
              <br />
              <span className="italic font-light">Sculpture</span>
            </h1>

            <p className="font-body text-[15px] text-[#5E6058] leading-[1.75] max-w-[380px]">
