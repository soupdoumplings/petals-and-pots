      ...
      <main className="w-full max-w-[1920px] mx-auto flex-grow pt-[140px] px-6 md:px-12 pb-32">
        <div className="max-w-6xl mx-auto w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-12">
               ...
               {/* Left Column Data - Wrapped in Elevated Card */}
               ...
               {/* Right Column Assets/Photos - Scaled down for Landscape perspective */}
               <div className="lg:col-span-4 space-y-8 h-full">
                   <div className="flex flex-col gap-3 h-full">
                     ...
                     <div className="flex-grow w-full border border-[#B1B3A9]/20 bg-white rounded-2xl shadow-sm flex flex-col items-center justify-center p-12 hover:border-[#785A1A] hover:bg-[#FBF9F4]/50 transition-all cursor-pointer group min-h-[400px]">
           ...
           {/* Action Handlers */}
           <div className="flex justify-between items-center bg-white rounded-2xl p-6 md:px-10 py-6 border border-[#B1B3A9]/20 shadow-sm">
              ...
              <button className="bg-[#5F5E5E] text-[#FAF7F6] px-10 py-4 font-label text-[12px] tracking-[1.5px] font-black uppercase flex items-center gap-3 hover:bg-[#31332C] rounded-lg transition-all transform hover:-translate-y-0.5 active:scale-95 shadow-xl shadow-black/10">
