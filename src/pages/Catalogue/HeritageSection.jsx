...
const HeritageSection = () => {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32 bg-[#F5F4ED] px-12 py-32 rounded-sm mx-auto max-w-[1440px] drop-shadow-sm group">
      {/* Visual Component */}
      <div className="relative overflow-hidden shadow-2xl shadow-black/10 h-[600px] border border-[#B1B3A9]/10">
        <img 
      ...
      <div className="text-left space-y-12">
        <div className="space-y-4">
           <h2 className="font-headline text-[80px] leading-tight text-[#31332C] tracking-tighter">Rooted in <br /><span className="italic font-light">Heritage</span></h2>
        </div>
        
        <div className="space-y-10 max-w-lg">
          <p className="font-body text-[#5E6058] leading-relaxed text-lg opacity-90 transition-opacity group-hover:opacity-100">
          ...
          <p className="font-body text-[#5E6058] leading-relaxed text-lg opacity-90">
          ...
          <div className="pt-16 mt-16 border-t border-[#B1B3A9]/30 space-y-10">
